   ...
   def __init__(self, *args, **kwargs):
       def openFile():
          tf = filedialog.askopenfilename(
              initialdir="/home/alagar/Desktop/New Folder/traffic-analysis/sample.access.log", 
              title="Open Log file", 
...
class Page2(Page):
   def __init__(self, *args, **kwargs):
       ...
       infile_name = '/home/alagar/Desktop/New Folder/traffic-analysis/sample.access.log'
       try:
